...
;;     (error-face ((t (:foreground ,scarletred3 :weight bold :underline t))))
     ...
     (outline-8 ((t (:foreground ,butter3))))
     (outline-7 ((t (:foreground ,butter3))))
     (outline-6 ((t (:foreground ,butter3))))
     (outline-5 ((t (:foreground ,butter3))))     
     (outline-4 ((t (:foreground ,butter3))))
     (outline-3 ((t (:foreground ,butter3))))
     (outline-2 ((t (:foreground ,butter3))))
     (outline-1 ((t (:foreground ,butter3))))
